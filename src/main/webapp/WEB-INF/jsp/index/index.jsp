        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="tip" class="jumbotron text-left" style="padding-left: 45px;background-color: #ffffff">
                    ...
                    <p>${hospital.hospitalAbout}</p>
                    <p><a class="btn btn-primary btn-lg" href="/ssm_pro/officeIndex/1" role="button">立即预约</a></p>
                </div>
...
<%--                <li class="active" data-slide-to="0" data-target="#slidershow"></li>--%>
                <li data-slide-to="1" data-target="#slidershow" class="active"></li>
                <li data-slide-to="2" data-target="#slidershow"></li>
                <li data-slide-to="3" data-target="#slidershow"></li>
            </ol>
            <div class="carousel-inner">
                <div class="item active">
                    <img alt="" src="${mybasePath}assets/img/1.png" style="width: 100%"/>
                ...
                <div class="item">
                    <img alt="" src="${mybasePath}assets/img/2.png" style="width: 100%"/>
                    <div class="carousel-caption">
                        <p>全国医院查询功能</p>
                ...
                <div class="item">
                    <img alt="" src="${mybasePath}assets/img/3.png" style="width: 100%"/>
                    <div class="carousel-caption">
                        <p>医生信息</p>
                        <p>20w+医生信息，助您提前了解。</p>
                    </div>
            ...
            <a class="left carousel-control" href="#slidershow" data-slide="prev" role="button">
