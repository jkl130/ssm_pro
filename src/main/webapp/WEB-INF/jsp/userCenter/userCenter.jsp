                        ...
                        <tr>
                                ...
                                <c:if test="${orderRecords.isFinish ==0 }">
                                    <c:if test="${orderRecords.isCancel ==0 }">
                                        <c:if test="${orderRecords.isSuccess ==0 }">
                                            <c:if test="${orderRecords.orderVer ==1 }">订单已提交</c:if>
                                        </c:if>
                                        <c:if test="${orderRecords.isSuccess ==1 }">
                                            <c:if test="${orderRecords.orderVer ==1 }">订单已支付</c:if>
                                        </c:if>
                                    </c:if>
                                </c:if>
                                <c:if test="${orderRecords.isCancel ==1 }">
                            ...
                            <td><c:if test="${orderRecords.isFinish==0 }">
                                <c:if test="${orderRecords.isCancel==0 }">
                                    ...
                                    <c:if test="${orderRecords.isSuccess ==0 }">
                                        <a href="javascript:void(0)" onclick="alipay(${orderRecords.id})">立即支付</a>
                                        <form id="alipay${orderRecords.id}" method="post"
                                              action="<c:url value='/alipay'/>" target="_blank">
                                            <input type="hidden" value="${orderRecords.id }" name="id" id="id">
                                        </form>
                                    </c:if>

                                </c:if>
                            </c:if>
                                <div class="modal fade" id="myPayDoneModal${orderRecords.id}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form id="payDone" method="post"
                                                      action="<c:url value="/payDone/${orderRecords.id}"/>">
                                                    <button class="btn btn-primary" data-dismiss="modal"
                                                            aria-hidden="true">否
                                                    </button>
                                                    <button class="btn btn-primary" id="submit1" name="submit"
                                                            onclick="payDone();">是
                                                    </button>
                                                </form>
                                            </div>
                            ...
                            <div class="col-md-12 text-left">
                                ...
                                <div
                                    ...
                                    <select style="margin-bottom: 6px;"
                                        ...
                                        <option value="${commonUser.userSex }"
                                                selected="selected">${commonUser.userSex }</option>
